...
def saveScan(host, start_port, end_port, scan_results):
    try:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == "1": #if the user selects 1 on the main menu then it will carry onto the selection of a desired host ip address
            ...
            scanPorts(host, int(start_port), int(end_port)) #this will scan all of the ports between the starting port and the ending port 
        elif choice == "2":
